...
const FeedbackCard = ({ content, name, title, img }) => (
  <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card bg-white border shadow-sm hover:transition hover:duration-500 hover:-translate-y-3 cursor-pointer">
